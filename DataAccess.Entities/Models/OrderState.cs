...
namespace DataAccess.Entities.Models
{
    ...
    {
        /// <summary>Процесс оформления не начат</summary>
        None,
        ...
        /// <summary>Ожидание ввода комментария к заказу (шаг оформления)</summary>
        WaitingForCommentText,

        /// <summary>Ожидание подтверждения заказа пользователем (шаг оформления)</summary>
        WaitingForConfirmation,

        /// <summary>Заказ создан, ожидает обработки</summary>
        Created,

        /// <summary>Заказ ожидает оплаты</summary>
        AwaitingPayment,

        /// <summary>Заказ оплачен</summary>
        Paid,

        /// <summary>Заказ подтвержден администратором</summary>
        Confirmed,

        /// <summary>Заказ отменен</summary>
        Cancelled,

        /// <summary>Заказ готовится</summary>
        InProgress,

        /// <summary>Заказ готов к выдаче</summary>
        Ready,

        /// <summary>Заказ передан курьеру</summary>
        AssignedToCourier,
